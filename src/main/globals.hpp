...
// Internal Ultrawide Width. 536:224 closely matches a 3440:1440 display,
// avoiding the small pillarbox bars produced by the previous 524-wide buffer.
const uint16_t S16_WIDTH_ULTRAWIDE = 536;
