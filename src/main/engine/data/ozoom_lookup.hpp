...
// JJP - revised zoom lookup table. This uses larger sprites sizes, which improves visuals in hi-res mode.
// Table format: (row number is input zoom level, 0..255 where 255 is maximum size):
//   [zoom level for sprite renderer], [dimensions lookup mask], [sprite size], [original sprite size]
//
// Sprite zoom seems to have been calculated as 3096576 / ((47 x [input zoom]) + 111)
// Which might have been (0x3F0 * 0x0C00) / (0x2F * [input_zoom]) + 0x6F)
//
// To better render in hires mode (where the canvas size is increased from 320x224 to 640x448), larger sprite sizes
// are used with appropriated scaled zoom factors. The fourth field, originally unused, is used to store the original
// sprite sizes, which is used in OSprites::do_sprite() to lookup the rendered size.
//
// Note - in hwsprites::render() we double the sprite sizes for hires mode.

const static uint16_t ZOOM_LOOKUP_HIRES[] =
{
    // SIZE5 tier → always use SIZE1 (4 steps up, zoom = native × 16)
    // At these zoom levels the sprite is tiny on screen; using SIZE1 ensures
    // each vehicle type shows its own unique graphic even at maximum distance,
    // instead of the shared generic sprite the original ROM provides for the
    // smaller SIZE tiers.
    0x3F00,0x0000,SIZE1,SIZE5,
    0x3F00,0x0000,SIZE1,SIZE5,
    0x3F00,0x0000,SIZE1,SIZE5,
    0x3F00,0x0000,SIZE1,SIZE5,
    0x3290,0x1000,SIZE1,SIZE5,
    0x2A30,0x2000,SIZE1,SIZE5,
    0x2430,0x3000,SIZE1,SIZE5,
    // SIZE4 tier → always use SIZE1 (3 steps up, zoom = native × 8)
    0x1F80,0x0000,SIZE1,SIZE4,
    0x1C08,0x0800,SIZE1,SIZE4,
    0x1948,0x1000,SIZE1,SIZE4,
    0x1700,0x1800,SIZE1,SIZE4,
    0x1518,0x2000,SIZE1,SIZE4,
    0x1380,0x2800,SIZE1,SIZE4,
    0x1218,0x3000,SIZE1,SIZE4,
    0x10D8,0x3800,SIZE1,SIZE4,
    // SIZE3 tier → always use SIZE1 (2 steps up, zoom = native × 4)
    0x0FC0,0x0000,SIZE1,SIZE3,
    0x0ED4,0x0400,SIZE1,SIZE3,
    0x0E04,0x0800,SIZE1,SIZE3,
    0x0D4C,0x0C00,SIZE1,SIZE3,
    0x0CA4,0x1000,SIZE1,SIZE3,
    0x0C0C,0x1400,SIZE1,SIZE3,
    0x0B80,0x1800,SIZE1,SIZE3,
    0x0B00,0x1C00,SIZE1,SIZE3,
    0x0A8C,0x2000,SIZE1,SIZE3,
    0x0A20,0x2400,SIZE1,SIZE3,
    0x09C0,0x2800,SIZE1,SIZE3,
    0x0964,0x2C00,SIZE1,SIZE3,
    0x090C,0x3000,SIZE1,SIZE3,
    0x08C0,0x3400,SIZE1,SIZE3,
    0x086C,0x3800,SIZE1,SIZE3,
    0x0830,0x3C00,SIZE1,SIZE3,
    0x7E0,0x0000,SIZE1,SIZE2,
    0x7A4,0x0200,SIZE1,SIZE2,
    0x76A,0x0400,SIZE1,SIZE2,
    0x736,0x0600,SIZE1,SIZE2,
    0x702,0x0800,SIZE1,SIZE2,
    0x6D2,0x0A00,SIZE1,SIZE2,
    0x6A6,0x0C00,SIZE1,SIZE2,
    0x67A,0x0E00,SIZE1,SIZE2,
    0x652,0x1000,SIZE1,SIZE2,
    0x62A,0x1200,SIZE1,SIZE2,
    0x606,0x1400,SIZE1,SIZE2,
    0x5E2,0x1600,SIZE1,SIZE2,
    0x5C0,0x1800,SIZE1,SIZE2,
    0x5A0,0x1A00,SIZE1,SIZE2,
    0x580,0x1C00,SIZE1,SIZE2,
    0x562,0x1E00,SIZE1,SIZE2,
    0x546,0x2000,SIZE1,SIZE2,
    0x52A,0x2200,SIZE1,SIZE2,
    0x510,0x2400,SIZE1,SIZE2,
    0x4F8,0x2600,SIZE1,SIZE2,
    0x4E0,0x2800,SIZE1,SIZE2,
    0x4C8,0x2A00,SIZE1,SIZE2,
    0x4B2,0x2C00,SIZE1,SIZE2,
    0x49C,0x2E00,SIZE1,SIZE2,
    0x486,0x3000,SIZE1,SIZE2,
    0x472,0x3200,SIZE1,SIZE2,
    0x460,0x3400,SIZE1,SIZE2,
    0x44C,0x3600,SIZE1,SIZE2,
    0x436,0x3800,SIZE1,SIZE2,
    0x428,0x3A00,SIZE1,SIZE2,
    0x418,0x3C00,SIZE1,SIZE2,
    0x408,0x3E00,SIZE1,SIZE2,
    0x3F0,0x0000,SIZE1,SIZE1,
    0x3F0,0x0000,SIZE1,SIZE1,
    0x3E0,0x0100,SIZE1,SIZE1,
    0x3D2,0x0200,SIZE1,SIZE1,
    0x3C2,0x0300,SIZE1,SIZE1,
    0x3B6,0x0400,SIZE1,SIZE1,
    0x3A8,0x0500,SIZE1,SIZE1,
    0x39B,0x0600,SIZE1,SIZE1,
    0x38E,0x0700,SIZE1,SIZE1,
    0x381,0x0800,SIZE1,SIZE1,
    0x375,0x0900,SIZE1,SIZE1,
    0x369,0x0A00,SIZE1,SIZE1,
    0x35E,0x0B00,SIZE1,SIZE1,
    0x353,0x0C00,SIZE1,SIZE1,
    0x348,0x0D00,SIZE1,SIZE1,
    0x33D,0x0E00,SIZE1,SIZE1,
    0x333,0x0F00,SIZE1,SIZE1,
    0x329,0x1000,SIZE1,SIZE1,
    0x31F,0x1100,SIZE1,SIZE1,
    0x315,0x1200,SIZE1,SIZE1,
    0x30C,0x1300,SIZE1,SIZE1,
    0x303,0x1400,SIZE1,SIZE1,
    0x2FA,0x1500,SIZE1,SIZE1,
    0x2F1,0x1600,SIZE1,SIZE1,
    0x2E8,0x1700,SIZE1,SIZE1,
    0x2E0,0x1800,SIZE1,SIZE1,
    0x2D8,0x1900,SIZE1,SIZE1,
    0x2D0,0x1A00,SIZE1,SIZE1,
    0x2D8,0x1B00,SIZE1,SIZE1,
    0x2C0,0x1C00,SIZE1,SIZE1,
    0x2B9,0x1D00,SIZE1,SIZE1,
    0x2B1,0x1E00,SIZE1,SIZE1,
    0x2AA,0x1F00,SIZE1,SIZE1,
    0x2A3,0x2000,SIZE1,SIZE1,
    0x29C,0x2100,SIZE1,SIZE1,
    0x295,0x2200,SIZE1,SIZE1,
    0x28F,0x2300,SIZE1,SIZE1,
    0x288,0x2400,SIZE1,SIZE1,
    0x282,0x2500,SIZE1,SIZE1,
    0x27C,0x2600,SIZE1,SIZE1,
    0x276,0x2700,SIZE1,SIZE1,
    0x270,0x2800,SIZE1,SIZE1,
    0x26A,0x2900,SIZE1,SIZE1,
    0x264,0x2A00,SIZE1,SIZE1,
    0x25E,0x2B00,SIZE1,SIZE1,
    0x259,0x2C00,SIZE1,SIZE1,
    0x253,0x2D00,SIZE1,SIZE1,
    0x24E,0x2E00,SIZE1,SIZE1,
    0x249,0x2F00,SIZE1,SIZE1,
    0x243,0x3000,SIZE1,SIZE1,
    0x23E,0x3100,SIZE1,SIZE1,
    0x239,0x3200,SIZE1,SIZE1,
    0x234,0x3300,SIZE1,SIZE1,
    0x230,0x3400,SIZE1,SIZE1,
    0x22B,0x3500,SIZE1,SIZE1,
    0x226,0x3600,SIZE1,SIZE1,
    0x222,0x3700,SIZE1,SIZE1,
    0x21B,0x3800,SIZE1,SIZE1,
    0x219,0x3900,SIZE1,SIZE1,
    0x214,0x3A00,SIZE1,SIZE1,
    0x210,0x3B00,SIZE1,SIZE1,
    0x20C,0x3C00,SIZE1,SIZE1,
    0x208,0x3D00,SIZE1,SIZE1,
    0x204,0x3E00,SIZE1,SIZE1,
    0x200,0x3F00,SIZE1,SIZE1,
    0x1F8,0x4000,SIZE1,SIZE1,
    0x1F8,0x4000,SIZE1,SIZE1,
    0x1F0,0x4100,SIZE1,SIZE1,
    0x1F0,0x4100,SIZE1,SIZE1,
    0x1E9,0x4200,SIZE1,SIZE1,
    0x1E9,0x4200,SIZE1,SIZE1,
    0x1E1,0x4300,SIZE1,SIZE1,
    0x1E1,0x4300,SIZE1,SIZE1,
    0x1DA,0x4400,SIZE1,SIZE1,
    0x1DA,0x4400,SIZE1,SIZE1,
    0x1D4,0x4500,SIZE1,SIZE1,
    0x1D4,0x4500,SIZE1,SIZE1,
    0x1CD,0x4600,SIZE1,SIZE1,
    0x1CD,0x4600,SIZE1,SIZE1,
    0x1C7,0x4700,SIZE1,SIZE1,
    0x1C7,0x4700,SIZE1,SIZE1,
    0x1C0,0x4800,SIZE1,SIZE1,
    0x1C0,0x4800,SIZE1,SIZE1,
    0x1BA,0x4900,SIZE1,SIZE1,
    0x1BA,0x4900,SIZE1,SIZE1,
    0x1B4,0x4A00,SIZE1,SIZE1,
    0x1B4,0x4A00,SIZE1,SIZE1,
    0x1AF,0x4B00,SIZE1,SIZE1,
    0x1AF,0x4B00,SIZE1,SIZE1,
    0x1A9,0x4C00,SIZE1,SIZE1,
    0x1A9,0x4C00,SIZE1,SIZE1,
    0x1A4,0x4D00,SIZE1,SIZE1,
    0x1A4,0x4D00,SIZE1,SIZE1,
    0x19E,0x4E00,SIZE1,SIZE1,
    0x19E,0x4E00,SIZE1,SIZE1,
    0x199,0x4F00,SIZE1,SIZE1,
    0x199,0x4F00,SIZE1,SIZE1,
    0x194,0x5000,SIZE1,SIZE1,
    0x194,0x5000,SIZE1,SIZE1,
    0x18F,0x5100,SIZE1,SIZE1,
    0x18F,0x5100,SIZE1,SIZE1,
    0x18A,0x5200,SIZE1,SIZE1,
    0x18A,0x5200,SIZE1,SIZE1,
    0x186,0x5300,SIZE1,SIZE1,
    0x186,0x5300,SIZE1,SIZE1,
    0x181,0x5400,SIZE1,SIZE1,
    0x181,0x5400,SIZE1,SIZE1,
    0x17D,0x5500,SIZE1,SIZE1,
    0x17D,0x5500,SIZE1,SIZE1,
    0x178,0x5600,SIZE1,SIZE1,
    0x178,0x5600,SIZE1,SIZE1,
    0x174,0x5700,SIZE1,SIZE1,
    0x174,0x5700,SIZE1,SIZE1,
    0x170,0x5800,SIZE1,SIZE1,
    0x170,0x5800,SIZE1,SIZE1,
    0x16C,0x5900,SIZE1,SIZE1,
    0x16C,0x5900,SIZE1,SIZE1,
    0x168,0x5A00,SIZE1,SIZE1,
    0x168,0x5A00,SIZE1,SIZE1,
    0x164,0x5B00,SIZE1,SIZE1,
    0x164,0x5B00,SIZE1,SIZE1,
    0x160,0x5C00,SIZE1,SIZE1,
    0x160,0x5C00,SIZE1,SIZE1,
    0x15C,0x5D00,SIZE1,SIZE1,
    0x15C,0x5D00,SIZE1,SIZE1,
    0x158,0x5E00,SIZE1,SIZE1,
    0x158,0x5E00,SIZE1,SIZE1,
    0x155,0x5F00,SIZE1,SIZE1,
    0x155,0x5F00,SIZE1,SIZE1,
    0x151,0x6000,SIZE1,SIZE1,
    0x151,0x6000,SIZE1,SIZE1,
    0x14E,0x6100,SIZE1,SIZE1,
    0x14E,0x6100,SIZE1,SIZE1,
    0x14A,0x6200,SIZE1,SIZE1,
    0x14A,0x6200,SIZE1,SIZE1,
    0x147,0x6300,SIZE1,SIZE1,
    0x147,0x6300,SIZE1,SIZE1,
    0x144,0x6400,SIZE1,SIZE1,
    0x144,0x6400,SIZE1,SIZE1,
    0x141,0x6500,SIZE1,SIZE1,
    0x141,0x6500,SIZE1,SIZE1,
    0x13E,0x6600,SIZE1,SIZE1,
    0x13E,0x6600,SIZE1,SIZE1,
    0x13B,0x6700,SIZE1,SIZE1,
    0x13B,0x6700,SIZE1,SIZE1,
    0x138,0x6800,SIZE1,SIZE1,
    0x138,0x6800,SIZE1,SIZE1,
    0x135,0x6900,SIZE1,SIZE1,
    0x135,0x6900,SIZE1,SIZE1,
    0x132,0x6A00,SIZE1,SIZE1,
    0x132,0x6A00,SIZE1,SIZE1,
    0x12F,0x6B00,SIZE1,SIZE1,
    0x12F,0x6B00,SIZE1,SIZE1,
    0x12C,0x6C00,SIZE1,SIZE1,
    0x12C,0x6C00,SIZE1,SIZE1,
    0x129,0x6D00,SIZE1,SIZE1,
    0x129,0x6D00,SIZE1,SIZE1,
    0x127,0x6E00,SIZE1,SIZE1,
    0x127,0x6E00,SIZE1,SIZE1,
    0x124,0x6F00,SIZE1,SIZE1,
    0x124,0x6F00,SIZE1,SIZE1,
    0x121,0x7000,SIZE1,SIZE1,
    0x121,0x7000,SIZE1,SIZE1,
    0x11F,0x7100,SIZE1,SIZE1,
    0x11F,0x7100,SIZE1,SIZE1,
    0x11C,0x7200,SIZE1,SIZE1,
    0x11C,0x7200,SIZE1,SIZE1,
    0x11A,0x7300,SIZE1,SIZE1,
    0x11A,0x7300,SIZE1,SIZE1,
    0x118,0x7400,SIZE1,SIZE1,
    0x118,0x7400,SIZE1,SIZE1,
    0x115,0x7500,SIZE1,SIZE1,
    0x115,0x7500,SIZE1,SIZE1,
    0x113,0x7600,SIZE1,SIZE1,
    0x113,0x7600,SIZE1,SIZE1,
    0x111,0x7700,SIZE1,SIZE1,
    0x111,0x7700,SIZE1,SIZE1,
    0x10E,0x7800,SIZE1,SIZE1,
    0x10E,0x7800,SIZE1,SIZE1,
    0x10C,0x7900,SIZE1,SIZE1,
    0x10C,0x7900,SIZE1,SIZE1,
    0x10A,0x7A00,SIZE1,SIZE1,
    0x10A,0x7A00,SIZE1,SIZE1,
    0x108,0x7B00,SIZE1,SIZE1,
    0x108,0x7B00,SIZE1,SIZE1,
    0x106,0x7C00,SIZE1,SIZE1,
    0x106,0x7C00,SIZE1,SIZE1,
    0x104,0x7D00,SIZE1,SIZE1,
    0x104,0x7D00,SIZE1,SIZE1,
    0x102,0x7E00,SIZE1,SIZE1,
    0x102,0x7E00,SIZE1,SIZE1,
    0x100,0x7F00,SIZE1,SIZE1,
    0x100,0x7F00,SIZE1,SIZE1,
};
